									  ...
									  <div class="inline fields" data-bind="foreach: extra">
										  <div class="field">
											  <div class="ui checkbox" 
											    ...
											    <input data-bind="checked: $parent.value,attr:{type:$parent.datatype, value:value, name: $parent.name}">
...
(function(a,path){
	...
	function Model(){
		...
		this.submit = function(){
			if(confirm('确定要提交吗？')){
				...
				a.http(path+'welcome/console/config/update').data({data:data}).post(function(res){
					// if(res.success) {
	...
	a.http(path+'welcome/console/config/options').post(function (res) {
		var data = res.data;
