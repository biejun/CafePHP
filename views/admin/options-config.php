				...
				<tfoot>
					<tr>
						<td colspan="8" class="text-right">
							<button type="submit" class="s-button s-primary mt-10" data-bind="click:addOptions,text:'添加'"></button>
							<button type="submit" class="s-button mt-10 ml-10" data-bind="click:removeItems,text:'取消'"></button>
						</td>
					</tr>
				</tfoot>
			</table>
			<table class="s-table" cellpadding="0" cellspacing="0" data-bind="if:newItems().length===0">
				...
				<tfoot>
					<tr>
						...
						<td></td>
						<td>
							<button type="submit" class="s-button s-primary mt-10" data-bind="click:submit,text:'提交'"></button>
						</td>
					</tr>
				</tfoot>
			</table>
