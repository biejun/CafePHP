...
Keystroke = (function(superClass) {
  ...
  Keystroke.prototype._initKeystrokeHandlers = function() {
    ...
    this.add('backspace', 'a', (function(_this) {
      return function(e, $node) {
        if(!$node.is('.simditor-mention')) {
            return;
        }
        var range = _this.editor.selection.range();
...
Toolbar = (function(superClass) {
  ...
  Toolbar.prototype._tpl = {
    wrapper: '<div class="simditor-toolbar" oncontextmenu=self.event.returnValue=false><ul></ul></div>',
...
LinkButton = (function(superClass) {
  ...
  LinkButton.prototype._status = function() {
    ...
    if (this.active && !this.editor.selection.rangeAtEndOf(this.node)) {
        if(this.node.is('.simditor-mention')) {
            var range = this.editor.selection.range();
            range.selectNode(this.node[0]);
            return this.popover.hide();
        }else{
            return this.popover.show(this.node);
        }
...
ImageButton = (function(superClass) {
    ...
    this.editor.uploader.on('uploadsuccess', (function(_this) {
      return function(e, file, result) {
        ...
        if (_this.popover.active) {
          ...
          return _this.popover.srcEl.val(result.data.filePath);
        }
      };
    })(this));
  ...
  ImageButton.prototype.loadImage = function($img, src, callback) {
    ...
    img.onload = (function(_this) {
      return function() {
        var height, width, maxWidth = 825, maxHeight = 800;
