...
<head>
    ...
    <link rel="stylesheet" href="<?=$this->viewPath;?>/css/install.css">
...
<body class="admin-body">
    <div id="App" class="wrap" data-allow-install="<?=$checkVersion?>" data-token="<?=$token?>">
        <div data-bind="attr:{class:'box step-'+step()}">
            <!-- ko if:step() === 1 -->
            <h3 class="welcome" data-bind="text:welcome,attr:{'aria-label':welcome}"></h3>
            <p class="tip" data-bind="text:checkVersion?'使用之前还需要进行一些必须配置，现在开始！':'您的PHP版本过低，建议您先升级PHP版本至5.5.38以上来完成安装。'">
            </p>
            ...
            <div class="copyright">©2018 Cafe.</div>
        </div>
    </div>
    ...
    <script type="text/javascript" src="<?=$this->viewPath;?>/js/install.js"></script>
</body>
</html>