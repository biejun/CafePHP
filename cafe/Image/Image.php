...
class Image
{
     ...
     * @return int
     */
    public static function watermark($source, $water, $savename = '', $position = 7, $alpha = 80)
    {
        # 检查原图或水印图是否存在
    ...
    public static function crop($image, $filename, $maxWidth=200, $maxHeight=200, $mode=1, $interlace=true)
    {
